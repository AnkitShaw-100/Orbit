 ...
 *
 * No illustration: a paper-trading terminal has nothing to show that is more
 * convincing than its own working panels priced off the live feed.
 */
export default function Hero({ tickers, status }) {
  return (
    <section className="grid lg:grid-cols-[1fr_minmax(0,44%)]">
      <div className="flex flex-col justify-between">
        <div className="px-6 pt-10 pb-14 sm:px-10 lg:pt-20 lg:pb-16 2xl:px-16">
          <p
            className="orbit-rise font-mono text-[11px] tracking-[0.18em] text-brand uppercase"
          >
      ...
      {/* The working panels, on a gold bloom over the terminal ground. */}
      <div className="brand-wash relative min-h-100 overflow-hidden border-t border-line sm:min-h-120 lg:min-h-140 lg:border-t-0 lg:border-l">
        <div className="grid-rule absolute inset-0 opacity-[0.35]" aria-hidden="true" />
